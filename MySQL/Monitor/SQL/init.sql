...
CREATE TABLE IF NOT EXISTS T_SLOW(
    ...
    USERHOST VARCHAR(30) COMMENT '该SQL来源的主机',
    ONDB VARCHAR(512) COMMENT 'SQL所在数据库',
    STARTTIME TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'SQL运行时间',
    QUERYTIME VARCHAR(15) COMMENT '查询时间',
    LOCKTIME VARCHAR(15) COMMENT 'SQL锁定时长',
    ROWSSEND INT(11) NOT NULL COMMENT '该SQL返回的记录数',
    ROWSEXAMINED INT(11) NOT NULL COMMENT '需检索的记录数',
    SLOWTEXT VARCHAR(1000) COMMENT 'SQL文本',
    OBJID CHAR(40) COMMENT 'MongoDB的ObjectId',
